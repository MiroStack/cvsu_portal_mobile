...
public final class FragmentCampusCalendarBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentCampusCalendarBinding(@NonNull FrameLayout rootView,
      @NonNull CalendarView calendarView, @NonNull ConstraintLayout constraintLayout2,
      @NonNull MaterialDivider materialDivider, @NonNull RecyclerView recyclerViewEvents) {
  ...
  @NonNull
  public static FragmentCampusCalendarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentCampusCalendarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_campus_calendar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentCampusCalendarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCampusCalendarBinding((FrameLayout) rootView, calendarView,
          constraintLayout2, materialDivider, recyclerViewEvents);
    }
