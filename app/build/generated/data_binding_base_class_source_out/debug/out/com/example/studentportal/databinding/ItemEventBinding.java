...
public final class ItemEventBinding implements ViewBinding {
  ...
  private ItemEventBinding(@NonNull LinearLayout rootView, @NonNull TextView textViewDate,
  ...
  public static ItemEventBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemEventBinding((LinearLayout) rootView, textViewDate, textViewTitle);
    }
